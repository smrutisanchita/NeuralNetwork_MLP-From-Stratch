...
if __name__ == '__main__':
    ...
    DM = deep_model(past_days=30, epochs=10)
    ...
    train_timeseries, val_timeseries, test_timeseries = DM.genarate_timeseries(x_train, y_train, x_val, y_val, x_test)

    model, history = DM.train_model(train_timeseries, val_timeseries, x_train.shape[1])
